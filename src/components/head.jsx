...
const head = (props) => {
  ...
  var SignIn = (
    <div className=" px-10 flex w-full">
      <span className="flex justify-center items-center flex-auto w-10 ">
        <svg
          viewBox="0 0 111 30"
          version="1.1"
          xmlns="http://www.w3.org/2000/svg"
          xmlns:xlik="http://www.w3.org/1999/xlink"
          aria-hidden="true"
          role="img"
      ...
      <span className="flex justify-center items-center flex-auto w-20">
        {currentEndpoint !== "/Signin" ? (
          <Link to="/Signin">
            <button
  ...
  return localStorage.getItem("tkId") ? logOut : SignIn;
};
